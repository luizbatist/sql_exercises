-- Exercícios de fixação da matéria do modulo 05
...
A empresa possui 16 produtos da marca Contoso, da cor Silver e com
...
FROM
	DimProduct
WHERE Weight BETWEEN 10 AND 30 AND ColorName = 'Silver' AND BrandName = 'Contoso'
